...
The generate_image.py file generates a number of images that has been trained by a Deep Convolutional Generative Adversarial Network (DCGAN), and returns 10000 generated images. The whole code is based on [this notebook](https://github.com/naokishibuya/deep-learning/blob/master/python/dcgan_celeba.ipynb) with several adjustments, which proposes a DCGAN using the same celebA dataset. 
